...
void loop() {
    ...
    for (int y = 0; y < 7; y++) {
        ...
        for (int x = 0; x < 12; x++) {
            double xx = x * 0.1;
            double td1 = sin(_time + y * 0.01);
            double td2 = sin(_time * 1.3 - x * 0.01 + 0.5);
            double td3 = sin(_time * 0.7 + x * 0.015 - y * 0.02 + 1.0);
            double td4 = sin(_time * 1.1 - x * 0.02 + y * 0.03 + 1.5);
            double td5 = sin(_time * 0.9 + x * 0.03 + y * 0.04 + 2.0);
            double td6 = sin(_time * 1.2 - x * 0.04 - y * 0.05 + 2.5);

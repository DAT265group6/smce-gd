...
ArduinoGraphics::ArduinoGraphics(int width, int height) : _width(width), _height(height), _font(NULL) {}
...
int ArduinoGraphics::width() { return _width; }

int ArduinoGraphics::height() { return _height; }
...
void ArduinoGraphics::fill(uint32_t color) { fill(COLOR_R(color), COLOR_G(color), COLOR_B(color)); }

void ArduinoGraphics::noFill() { _fill = false; }
...
void ArduinoGraphics::stroke(uint32_t color) { stroke(COLOR_R(color), COLOR_G(color), COLOR_B(color)); }

void ArduinoGraphics::noStroke() { _stroke = false; }
...
void ArduinoGraphics::textFont(const Font& which) { _font = &which; }

int ArduinoGraphics::textFontWidth() const { return (_font ? _font->width : 0); }

int ArduinoGraphics::textFontHeight() const { return (_font ? _font->height : 0); }
...
void ArduinoGraphics::flush() { _textBuffer = ""; }
...
void ArduinoGraphics::textScrollSpeed(unsigned long speed) { _textScrollSpeed = speed; }

...
execute_process(
  COMMAND "/opt/homebrew/bin/git" show-ref "3.x"
  WORKING_DIRECTORY "/Users/weiguo/Desktop/smce-gd-group/build/_deps/fc-godot-cpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("3.x" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/weiguo/Desktop/smce-gd-group/build/_deps/fc-godot-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/weiguo/Desktop/smce-gd-group/build/_deps/fc-godot-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
